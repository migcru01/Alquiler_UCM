...
- [x] solicitar Oferta (Hugo)
- [ ] Registrarse
- [ ] cerrar sesión
- [ ] interesarse por Oferta(cuando esté en medio de un tramite y no se puede solicitar, se interesa y mandara una notif si esta está disponible)
- [ ] Ver mensajes de solicitudes (estudiante)
- [ ] Abrir localización habitacion en Maps o equivalente (por el iframe)
- [ ] filtrar ofertas por "insertar filtro"
- [x] añadir oferta (Viñas)
- [x] Eliminar oferta (Viñas)
- [ ] Modificar oferta vigente 
- [ ] ver mis habitaciones y filtrar (Propietario)
- [ ] Aceptar solicitud estudiante y comenzar conversación
- [ ] rechazar estudiante
- [ ] 
